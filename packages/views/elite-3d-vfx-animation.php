...
<!-- Mirrored from websitevalley.co.uk/packages/elite-3d-vfx-animation by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:27 GMT -->
<!-- Added by HTTrack -->


<head>
    <title>Elite 3D VFX Animation that your audience cannot resist </title>

    <meta name="description" content="Elite 3D VFX package provides you top-notch 3D animations, including the character rigging, professional voice over, lighting, etc at reasonable price.">
...
<meta property="og:locale" content="en_GB" />
  ...
  <meta property="og:title" content="Elite 3D VFX Animation that your audience cannot resist" />
  <meta property="og:description" content="Elite 3D VFX package provides you top-notch 3D animations, including the character rigging, professional voice over, lighting, etc at reasonable price." />
...
<?php include_once($_SERVER['DOCUMENT_ROOT'].'/includes/header.php');?>
        ...
        <div class="works-wrap">
            ...
            <section class="subscribe-fold sec-padding-60 d-none">
                ...
                <div class="container">
                    <div class="col-md-12">
                        <h1 class="myheading">Elite 3D VFX Animation</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="subs-pac bronze ">
                                ...
                                <h6><span class="old">£5019.98</span> £2509.99
                                ...
                                <div class="table-packages bronze">
                                    ...
                                    <div class="body">
                                        <ul class="subscription-list">
                                            <li>
                                                <h6>60s Duration - HD 1080</h6>
                                            </li>
                                            <li>
                                                <h6>Unlimited Edits/Revisions &amp; Concepts</h6>
                                            </li>
                                            <li>
                                                <h6>Professional Script</h6>
                                            </li>
                                            <li>
                                                <h6>Concept and Storyboards</h6>
                                            </li>
                                            <li>
                                                <h6>3D Modeling</h6>
                                            </li>
                                            ...
                                            <li>
                                                <h6>Camera Setting</h6>
                                            </li>
                                            <li>
                                                <h6>Rendering</h6>
                                            </li>
                                            <li>
                                                <h6>Compositing and Special VFX</h6>
                                            </li>
                                            <li>
                                                <h6>Music and Foley</h6>
                                            </li>
                                            <li>
                                                <h6>Custom Setting, 2 Characters &amp; Graphics</h6>
                                            </li>
                                            <li>
                                                <h6>Animation Effects &amp; Visualization</h6>
                                            </li>
                                            <li>
                                                <h6>Voice Over - All accents (M/F)</h6>
                                            </li>
                                            <li>
                                                <h6>Editing and Final Output</h6>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                              ...
                              <option value="SEO">SEO</option>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="fldset">
                                                ...
                                                <input type="hidden" id="locationURL" name="page" value="https://websitevalley.co.uk/packages/elite-3d-vfx-animation" />
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="book-call-popupform tabform clearfix  text-left">
                        ...
                        <form id="popupfrm" class="cmxform" method="POST" action="">
                            ...
                            <div class="fldst">
                                ...
                                <input type="hidden" id="location" name="locationURL" value="http://websitevalley.co.uk/packages/elite-3d-vfx-animation" />
                            </div>
...
<!-- Mirrored from websitevalley.co.uk/packages/elite-3d-vfx-animation by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:28 GMT -->

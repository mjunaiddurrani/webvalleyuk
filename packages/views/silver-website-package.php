...
<!-- Mirrored from websitevalley.co.uk/packages/silver-website-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:12 GMT -->
<!-- Added by HTTrack -->


<head>
    <title>Web Design Development Silver Packages for businesses</title>

    <meta name="description" content="With our silver package for web design and development, get more than expected. We help you increase your online customers, and generate more sales online.">
...
<meta property="og:locale" content="en_GB" />
  ...
  <meta property="og:title" content="Web Design Development Silver Packages for businesses" />
  <meta property="og:description" content="With our silver package for web design and development, get more than expected. We help you increase your online customers, and generate more sales online." />
...
<?php include_once($_SERVER['DOCUMENT_ROOT'].'/includes/header.php');?>
        ...
        <div class="works-wrap">
            ...
            <section class="subscribe-fold sec-padding-60">
                ...
                <div class="container">
                    <div class="col-md-12">
                        <h1 class="myheading">Silver Website Package</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="subs-pac bronze ">
                                ...
                                <h6><span class="old">£3219.99</span> £1599.99
                                ...
                                <div class="table-packages bronze">
                                    ...
                                    <div class="body">
                                        <ul class="subscription-list">
                                            <li>
                                                <h6>15 to 20 Pages Website</h6>
                                            </li>
                                            <li>
                                                <h6>Custom Made, Interactive, Dynamic &amp; High End Design</h6>
                                            </li>
                                            <li>
                                                <h6>Custom WP (or) Custom PHP Development</h6>
                                            </li>
                                            <li>
                                                <h6>1 jQuery Slider Banner</h6>
                                            </li>
                                            <li>
                                                <h6>Up to 10 Custom Made Banner Designs</h6>
                                            </li>
                                            <li>
                                                <h6>10 Stock Images</h6>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <h6>FREE 5 Years Domain Name</h6>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <h6>Industry Specified Team of Expert Designers and Developers</h6>
                                            </li>
                                            <li>
                                                <h6>Complete Deployment</h6>
                                            </li>
                                            <li>
                                                <h6>Dedicated Accounts Manager</h6>
                                            </li>
                                            <li>
                              ...
                              <option value="SEO">SEO</option>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="fldset">
                                                ...
                                                <input type="hidden" id="locationURL" name="page" value="https://websitevalley.co.uk/packages/silver-website-package" />
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="book-call-popupform tabform clearfix  text-left">
                        ...
                        <form id="popupfrm" class="cmxform" method="POST" action="">
                            ...
                            <div class="fldst">
                                ...
                                <input type="hidden" id="location" name="locationURL" value="http://websitevalley.co.uk/packages/silver-website-package" />
                            </div>
...
<!-- Mirrored from websitevalley.co.uk/packages/silver-website-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:13 GMT -->

...
<head>
    ...
    <meta name="description" content="Looking for Web Design Development Professional Website Packages? No worries, we have the best web package for your website design and development needs.">
...
<meta property="og:locale" content="en_GB" />
  ...
  <meta property="og:title" content="Web Design Development Professional Website Packages" />
  <meta property="og:description" content="Looking for Web Design Development Professional Website Packages? No worries, we have the best web package for your website design and development needs." />
...
<?php include_once($_SERVER['DOCUMENT_ROOT'].'/includes/header.php');?>
        ...
        <div class="works-wrap">
            ...
            <section class="subscribe-fold sec-padding-60 d-none">
                ...
                <div class="container">
                    <div class="col-md-12">
                        <h1 class="myheading">Professional Website Package</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="subs-pac bronze ">
                                ...
                                <h6><span class="old">£819.99</span> £399.99
                              ...
                              <option value="SEO">SEO</option>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="fldset">
                                                ...
                                                <input type="hidden" id="locationURL" name="page" value="https://websitevalley.co.uk/packages/professional-website-package" />
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="book-call-popupform tabform clearfix  text-left">
                        ...
                        <form id="popupfrm" class="cmxform" method="POST" action="">
                            ...
                            <div class="fldst">
                                ...
                                <input type="hidden" id="location" name="locationURL" value="http://websitevalley.co.uk/packages/professional-website-package" />
                            </div>
...
<!-- Mirrored from websitevalley.co.uk/packages/professional-website-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:10 GMT -->

...
<!-- Mirrored from websitevalley.co.uk/packages/brochure-flyer-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:21 GMT -->
<!-- Added by HTTrack -->


<head>
    <title>Create Brochure, or Flyers for marketing purposes</title>

    <meta name="description" content="Market about your brand or business through stunning brochures and flyers. We offer you packages that turn your visions into reality. contact for more info.">
...
<meta property="og:locale" content="en_GB" />
  ...
  <meta property="og:title" content="Create Brochure, or Flyers for marketing purposes" />
  <meta property="og:description" content="Market about your brand or business through stunning brochures and flyers. We offer you packages that turn your visions into reality. contact for more info." />
...
<?php include_once($_SERVER['DOCUMENT_ROOT'].'/includes/header.php');?>
        ...
        <div class="works-wrap">
            ...
            <section class="subscribe-fold sec-padding-60">
                ...
                <div class="container">
                    <div class="col-md-12">
                        <h1 class="myheading">Brochure/Flyer Package</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="subs-pac bronze ">
                                ...
                                <h6><span class="old">£269.98</span> £134.99
                                ...
                                <div class="table-packages bronze">
                                    ...
                                    <div class="body">
                                        <ul class="subscription-list">
                                            <li>
                                                <h6>1 Unique Design</h6>
                                            </li>
                                            <li>
                                                <h6>4 Design concepts (Trifold / Bi-fold)</h6>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <h6>Turnaround Time - 48 - 72 Hours</h6>
                                            </li>
                              ...
                              <option value="SEO">SEO</option>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="fldset">
                                                ...
                                                <input type="hidden" id="locationURL" name="page" value="https://websitevalley.co.uk/packages/brochure-flyer-package" />
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="book-call-popupform tabform clearfix  text-left">
                        ...
                        <form id="popupfrm" class="cmxform" method="POST" action="">
                            ...
                            <div class="fldst">
                                ...
                                <input type="hidden" id="location" name="locationURL" value="http://websitevalley.co.uk/packages/brochure-flyer-package" />
                            </div>
...
<!-- Mirrored from websitevalley.co.uk/packages/brochure-flyer-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:22 GMT -->

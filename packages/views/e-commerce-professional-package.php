...
<!-- Mirrored from websitevalley.co.uk/packages/e-commerce-professional-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:14 GMT -->
<!-- Added by HTTrack -->


<head>
    <title>Our ecommerce Professional Package for Businesses</title>

    <meta name="description" content="Setting up your professional business, or revamping your existing brand, it's not a problem anymore. We are here to offer the best price for our services.">
...
<meta property="og:locale" content="en_GB" />
  ...
  <meta property="og:title" content="Our ecommerce Professional Package for Businesses" />
  <meta property="og:description" content="Setting up your professional business, or revamping your existing brand, it's not a problem anymore. We are here to offer the best price for our services." />
...
<?php include_once($_SERVER['DOCUMENT_ROOT'].'/includes/header.php');?>
        ...
        <div class="works-wrap">
            ...
            <section class="subscribe-fold sec-padding-60 d-none">
                ...
                <div class="container">
                    <div class="col-md-12">
                        <h1 class="myheading">E-Commerce Professional Website Package</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="subs-pac bronze ">
                                <h3>E-Commerce Professional <br/>Website Package</h3>
                                <h6><span class="old">£2,788.00</span> £1,394.00
                              ...
                              <option value="SEO">SEO</option>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="fldset">
                                                ...
                                                <input type="hidden" id="locationURL" name="page" value="https://websitevalley.co.uk/packages/e-commerce-professional-package" />
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="book-call-popupform tabform clearfix  text-left">
                        ...
                        <form id="popupfrm" class="cmxform" method="POST" action="">
                            ...
                            <div class="fldst">
                                ...
                                <input type="hidden" id="location" name="locationURL" value="http://websitevalley.co.uk/packages/e-commerce-professional-package" />
                            </div>
...
<!-- Mirrored from websitevalley.co.uk/packages/e-commerce-professional-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:15 GMT -->

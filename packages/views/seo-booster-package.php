...
<!-- Mirrored from websitevalley.co.uk/packages/seo-booster-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:28 GMT -->
<!-- Added by HTTrack -->
...
<?php include_once($_SERVER['DOCUMENT_ROOT'].'/includes/header.php');?>
        ...
        <div class="works-wrap">
            ...
            <section class="subscribe-fold sec-padding-60 d-none">
                ...
                <div class="container">
                    <div class="col-md-12">
                        <h1 class="myheading">Seo Booster Package</h1>

                        <p class="mytext">£600 – Quarterly Plan</p>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="subs-pac bronze ">
                                ...
                                <h6><span class="old">£400.00</span> £200.00
                                ...
                                <div class="table-packages bronze">
                                    ...
                                    <div class="body">
                                        <ul class="subscription-list">
                                            ...
                                            <li>
                                                <h6>Pages Optimized (10 pages) </h6>
                                            </li>
                                            <li>
                                                <h6>Keyword Research</h6>
                                            </li>
                                            <li>
                                                <h6>Keyword Grouping</h6>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <h6>URL Rewrites (10 URL rewrites)</h6>
                                            </li>
                                            <li>
                                                <h6>Broken Link Report</h6>
                                            </li>
                              ...
                              <option value="SEO">SEO</option>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="fldset">
                                                ...
                                                <input type="hidden" id="locationURL" name="page" value="https://websitevalley.co.uk/packages/seo-booster-package" />
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="book-call-popupform tabform clearfix  text-left">
                        ...
                        <form id="popupfrm" class="cmxform" method="POST" action="">
                            ...
                            <div class="fldst">
                                ...
                                <input type="hidden" id="location" name="locationURL" value="http://websitevalley.co.uk/packages/seo-booster-package" />
                            </div>
...
<!-- Mirrored from websitevalley.co.uk/packages/seo-booster-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:29 GMT -->

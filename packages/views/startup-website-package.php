...
<!-- Mirrored from websitevalley.co.uk/packages/startup-website-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:07 GMT -->
<!-- Added by HTTrack -->
...
<meta property="og:locale" content="en_GB" />
  ...
  <meta property="og:title" content="Web Design Development Startup Packages for Enterprises" />
  <meta property="og:description" content="At Website Valley, we are offering affordable Web Design Development Startup Packages for Enterprises so that you have the perfect web design experience." />
...
<?php include_once($_SERVER['DOCUMENT_ROOT'].'/includes/header.php');?>
        ...
        <div class="works-wrap">
            ...
            <section class="subscribe-fold sec-padding-60 ">
                ...
                <div class="container">
                    <div class="col-md-12">
                        <h1 class="myheading">Startup Website Package</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="subs-pac bronze ">
                                ...
                                <h6><span class="old">£460.00</span> £220.99
                              ...
                              <option value="SEO">SEO</option>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="fldset">
                                                ...
                                                <input type="hidden" id="locationURL" name="page" value="https://websitevalley.co.uk/packages/startup-website-package" />
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="book-call-popupform tabform clearfix  text-left">
                        ...
                        <form id="popupfrm" class="cmxform" method="POST" action="">
                            ...
                            <div class="fldst">
                                ...
                                <input type="hidden" id="location" name="locationURL" value="http://websitevalley.co.uk/packages/startup-website-package" />
                            </div>
...
<!-- Mirrored from websitevalley.co.uk/packages/startup-website-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:08 GMT -->

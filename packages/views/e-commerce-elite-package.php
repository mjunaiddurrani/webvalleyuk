...
<!-- Mirrored from websitevalley.co.uk/packages/e-commerce-elite-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:15 GMT -->
<!-- Added by HTTrack -->


<head>
    <title>Our ecommerce Elite Package for Professional Businesses</title>

    <meta name="description" content="Specially designed elite package for your branding needs. Whether you are a startup or a well-established business, we will help you reach your goals.">
...
<meta property="og:locale" content="en_GB" />
  ...
  <meta property="og:title" content="Our ecommerce Elite Package for Professional Businesses" />
  <meta property="og:description" content="Specially designed elite package for your branding needs. Whether you are a startup or a well-established business, we will help you reach your goals." />
...
<?php include_once($_SERVER['DOCUMENT_ROOT'].'/includes/header.php');?>
        ...
        <div class="works-wrap">
            ...
            <section class="subscribe-fold sec-padding-60">
                ...
                <div class="container">
                    <div class="col-md-12">
                        <h1 class="myheading">E-Commerce Elite Website Package</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="subs-pac bronze ">
                                <h3>E-Commerce Elite Website <br/>Package</h3>
                                <h6><span class="old">£7,388.00</span> £3,694.00
                                ...
                                <div class="table-packages bronze">
                                    ...
                                    <div class="body">
                                        <ul class="subscription-list">
                                            ...
                                            <li>
                                                <h6>Sign age Design (OR) Label Design</h6>
                                            </li>
                                            <li>
                              ...
                              <option value="SEO">SEO</option>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="fldset">
                                                ...
                                                <input type="hidden" id="locationURL" name="page" value="https://websitevalley.co.uk/packages/e-commerce-elite-package" />
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="book-call-popupform tabform clearfix  text-left">
                        ...
                        <form id="popupfrm" class="cmxform" method="POST" action="">
                            ...
                            <div class="fldst">
                                ...
                                <input type="hidden" id="location" name="locationURL" value="http://websitevalley.co.uk/packages/e-commerce-elite-package" />
                            </div>
...
<!-- Mirrored from websitevalley.co.uk/packages/e-commerce-elite-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:16 GMT -->

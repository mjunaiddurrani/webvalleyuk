...
<!-- Mirrored from websitevalley.co.uk/packages/professional-3d-vfx-animation by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:26 GMT -->
<!-- Added by HTTrack -->


<head>
    <title>Professional 3D VFX Animation for unique brand identity </title>

    <meta name="description" content="We create professional 3D VFX animations and designs that are powerful to engage your customers online. We do unlimited revisions, 3d modeling, and more.">
...
<?php include_once($_SERVER['DOCUMENT_ROOT'].'/includes/header.php');?>
        ...
        <div class="works-wrap">
            ...
            <section class="subscribe-fold sec-padding-60">
                ...
                <div class="container">
                    <div class="col-md-12">
                        <h1 class="myheading">Professional 3D VFX Animation</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="subs-pac bronze ">
                                ...
                                <h6><span class="old">£4019.98</span> £2009.99
                              ...
                              <option value="SEO">SEO</option>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="fldset">
                                                ...
                                                <input type="hidden" id="locationURL" name="page" value="https://websitevalley.co.uk/packages/professional-3d-vfx-animation" />
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="book-call-popupform tabform clearfix  text-left">
                        ...
                        <form id="popupfrm" class="cmxform" method="POST" action="">
                            ...
                            <div class="fldst">
                                ...
                                <input type="hidden" id="location" name="locationURL" value="http://websitevalley.co.uk/packages/professional-3d-vfx-animation" />
                            </div>
...
<!-- Mirrored from websitevalley.co.uk/packages/professional-3d-vfx-animation by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:27 GMT -->

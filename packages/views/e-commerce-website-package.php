...
<!-- Mirrored from websitevalley.co.uk/packages/e-commerce-website-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:11 GMT -->
<!-- Added by HTTrack -->


<head>
    <title>Web Design Development ecommerce website Packages </title>

    <meta name="description" content="Increase your brand worth, and develop the killer ecommerce website that engages customers online. Avail our web package at competitive market price.">
...
<meta property="og:locale" content="en_GB" />
  ...
  <meta property="og:title" content="Web Design Development ecommerce website Packages" />
  <meta property="og:description" content="Increase your brand worth, and develop the killer ecommerce website that engages customers online. Avail our web package at competitive market price." />
...
<?php include_once($_SERVER['DOCUMENT_ROOT'].'/includes/header.php');?>
        ...
        <div class="works-wrap">
            ...
            <section class="subscribe-fold sec-padding-60 d-none">
                ...
                <div class="container">
                    <div class="col-md-12">
                        <h1 class="myheading">E-Commerce Website Package</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="subs-pac bronze ">
                                ...
                                <h6><span class="old">£2009.99</span> £999.99
                                ...
                                <div class="table-packages bronze">
                                    ...
                                    <div class="body">
                                        <ul class="subscription-list">
                                            <li>
                                                <h6>Upto 15 Unique Pages Website</h6>
                                            </li>
                                            <li>
                              ...
                              <option value="SEO">SEO</option>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="fldset">
                                                ...
                                                <input type="hidden" id="locationURL" name="page" value="https://websitevalley.co.uk/packages/e-commerce-website-package" />
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="book-call-popupform tabform clearfix  text-left">
                        ...
                        <form id="popupfrm" class="cmxform" method="POST" action="">
                            ...
                            <div class="fldst">
                                ...
                                <input type="hidden" id="location" name="locationURL" value="http://websitevalley.co.uk/packages/e-commerce-website-package" />
                            </div>
...
<!-- Mirrored from websitevalley.co.uk/packages/e-commerce-website-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:12 GMT -->

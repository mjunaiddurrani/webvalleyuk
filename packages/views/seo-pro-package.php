...
<!-- Mirrored from websitevalley.co.uk/packages/seo-pro-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:30 GMT -->
<!-- Added by HTTrack -->
...
<?php include_once($_SERVER['DOCUMENT_ROOT'].'/includes/header.php');?>
        ...
        <div class="works-wrap">
            ...
            <section class="subscribe-fold sec-padding-60 d-none">
                ...
                <div class="container">
                    <div class="col-md-12">
                        <h1 class="myheading">Seo Pro Package</h1>

                        <p class="mytext">£1800 – Quarterly Plan</p>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="subs-pac bronze ">
                                ...
                                <h6><span class="old">£1,200.00</span> £600.00
                                    <!-- <b>USD</b> --><span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for existing companies</span></h6>
                                ...
                                <div class="table-packages bronze">
                                    ...
                                    <div class="body">
                                        <ul class="subscription-list">
                                            ...
                                            <li>
                                                <h6>Consumer Analysis</h6>
                                            </li>
                                            <li>
                                                <h6>30 Selected Keywords Targeting</h6>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <h6>Indexing Modifications</h6>
                                            </li>
                                            <li class="heading">Tracking &amp; Analysis</li>
                                            <li>
                                                <h6>Google Places Inclusions</h6>
                                            </li>
                                            <li>
                                                <h6>Google Analytics Installation</h6>
                                            </li>
                                            <li>
                                                <h6>Call To Action Plan</h6>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <h6>Directory Submission</h6>
                                            </li>
                                            <li>
                                                <h6>Local Business Listings</h6>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                              ...
                              <option value="SEO">SEO</option>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="fldset">
                                                ...
                                                <input type="hidden" id="locationURL" name="page" value="https://websitevalley.co.uk/packages/seo-pro-package" />
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="book-call-popupform tabform clearfix  text-left">
                        ...
                        <form id="popupfrm" class="cmxform" method="POST" action="">
                            ...
                            <div class="fldst">
                                ...
                                <input type="hidden" id="location" name="locationURL" value="http://websitevalley.co.uk/packages/seo-pro-package" />
                            </div>
...
<!-- Mirrored from websitevalley.co.uk/packages/seo-pro-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:32 GMT -->

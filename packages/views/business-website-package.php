...
<!-- Mirrored from websitevalley.co.uk/packages/business-website-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:16 GMT -->
<!-- Added by HTTrack -->


<head>
    <title>Business Website Package for Pro Web App Development </title>

    <meta name="description" content="Our business website package is suitable for small and medium-sized businesses. Avail the best package for web app creation and stay stress-free. Contact.">
...
<?php include_once($_SERVER['DOCUMENT_ROOT'].'/includes/header.php');?>
        ...
        <div class="works-wrap">
            ...
            <section class="subscribe-fold sec-padding-60">
                ...
                <div class="container">
                    <div class="col-md-12">
                        <h1 class="myheading">Business Website Package</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="subs-pac bronze ">
                                <h3>Business <br/>Website Package</h3>
                                <h6><span class="old">£3998.00</span> £1999.00
                                ...
                                <div class="table-packages bronze">
                                    ...
                                    <div class="body">
                                        <ul class="subscription-list">
                                            ...
                                            <li>
                                                <h6>15 Seconds 2D Explainer Video</h6>
                                            </li>
                                            <li>
                                                <h6>Voice - Over &amp; Sound Effects</h6>
                                            </li>
                                            <li>
                                                <h6>Professional Script Writing</h6>
                                            </li>
                                            <li>
                                                <h6>Storyboard</h6>
                                            </li>
                              ...
                              <option value="SEO">SEO</option>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="fldset">
                                                ...
                                                <input type="hidden" id="locationURL" name="page" value="https://websitevalley.co.uk/packages/business-website-package" />
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="book-call-popupform tabform clearfix  text-left">
                        ...
                        <form id="popupfrm" class="cmxform" method="POST" action="">
                            ...
                            <div class="fldst">
                                ...
                                <input type="hidden" id="location" name="locationURL" value="http://websitevalley.co.uk/packages/business-website-package" />
                            </div>
...
<!-- Mirrored from websitevalley.co.uk/packages/business-website-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:17 GMT -->

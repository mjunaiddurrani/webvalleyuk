...
<!-- Mirrored from websitevalley.co.uk/ourpackages/automated-Interactive-conferencing-portal by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:17 GMT -->
<!-- Added by HTTrack -->


<head>
    <title>Automated/Interactive Conferencing Portal for Business</title>

    <meta name="description" content="Create an automated or integrative conferencing portal to manage your team or clients. We offer complete custom development along with CMS, UIX, and others.">
    ...
    <main class="app-container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <ul class="top-info-list">
                                <li>
                                    <a href="tel:+44 2038 856237"><img src="../assets/images/uk-flag.png" alt="UK Flag" />+44 2038 856237</a>
                                </li>
        ...
        <div class="works-wrap">
            ...
            <section class="subscribe-fold sec-padding-60">
                ...
                <div class="container">
                    <div class="col-md-12">
                        <h1 class="myheading">Automated/Interactive Conferencing Portal</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="subs-pac bronze ">
                                <h3>Automated/Interactive <br> Conferencing Portal</h3>
                                <h6><span class="old">£7998.00</span>£3999.00
                                ...
                                <div class="table-packages bronze">
                                    ...
                                    <div class="body">
                                        <ul class="subscription-list">
                                            ...
                                            <li>
                                                <h6>Automated Course Creation</h6>
                                            </li>
                                            <li>
                                                <h6>Video Conferencing</h6>
                                            </li>
                                            <li>
                                                <h6>Skills/Certification Tracking</h6>
                                            </li>
                                            <li>
                                                <h6>Mobile Learning</h6>
                                            </li>
                                            <li>
                                                <h6>Asynchronous Learning</h6>
                                            </li>
                                            <li>
                                                <h6>CRM Features</h6>
                                            </li>
                                            ...
                                            <li>
                                                <h6>Social Learning/Message Boards</h6>
                                            </li>
                                            <li>
                                                <h6>Motivational Triggers</h6>
                                            </li>
                                            <li>
                                                <h6>Forums And Webinars</h6>
                                            </li>
                                            <li>
                                                <h6>E-commerce And Subscriptions</h6>
                                            </li>
                                            <li>
                                                <h6>Online Course Booking</h6>
                                            </li>
                                            <li>
                                                <h6>Excellent Reporting</h6>
                                            </li>
                                            <li>
                                                <h6>Invoicing Integration</h6>
                                            </li>
                                            <li>
                                                <h6>Financial Integrations</h6>
                                            </li>
                                            <li>
                                                <h6>Student Information management</h6>
                                            </li>
                                            <li>
                                                <h6>Automated communications</h6>
                                            </li>
                                            <li>
                                                <h6>Learning Management System</h6>
                                            </li>
                                            <li>
                                                <h6>Quick And Easy Course Scheduling</h6>
                                            </li>
                                            <li>
                                                <h6>Reporting And Data Analysis</h6>
                                            </li>
                                            <li>
                                                <h6>Assessment Management &amp; Live Feedback</h6>
                                            </li>
                                            <li>
                                                <h6>Gradebooks</h6>
                                            </li>
                                            <li>
                                                <h6>Quick User Integration</h6>
                                            </li>
                                            <li>
                                                <h6>Easy Payment Methods</h6>
                                            </li>
                                            <li>
                                                <h6>Online Communities &amp; Social Engagement</h6>
                                            </li>
                                            <li>
                                                <h6>Curation of Resources And Adding Own Resources</h6>
                                            </li>
 ...
 <?php include_once($_SERVER['DOCUMENT_ROOT'].'/includes/form.php');?>
                        ...
                        <div class="col-lg-12">
                            <div class="iconswrap">
                                <div class="mycenter">
                                    <ul class="topajencies">
                                        <li style="    margin-right: 25px;">
                                            <figure>
                                                <img src="../assets/images/trust-verified.png" alt="payment" style="height: auto;">
                                            </figure>
                                        </li>
                                        <li>
                                            <figure>
                                                <img src="../assets/images/copyscape.png" alt="payment" style="height: auto;">
                                            </figure>
                                        </li>
                                        <li>
                                            <figure>
                                                <img src="../assets/images/partner1.png" alt="payment">
                                            </figure>
                                        </li>
                                        <li>
                                            <figure>
                                                <img src="../assets/images/partner5.png" alt="payment">
                                            </figure>
                                        </li>
                                        <li>
                                            <figure>
                                                <img src="../assets/images/partner2.png" alt="payment">
                                            </figure>
                                        </li>
                                    </ul>
                                </div>
                                <div class="footer-img">
                                    <figure>
                                        <img src="../assets/images/payment-icon.png" alt="payment">
                                    </figure>
                                </div>
    ...
    <div class="mypopup-wrap active" style="display: none;">
        <div class="mypopup">
            <div class="left">
                <figure>
                    <img class="lazy loaded" src="../" data-src="assets/images/popup-inner.png" data-was-processed="true" alt="not found">
                </figure>
            </div>
            <div class="right">

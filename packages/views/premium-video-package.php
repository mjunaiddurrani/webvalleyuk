...
<!-- Mirrored from websitevalley.co.uk/packages/premium-video-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:24 GMT -->
<!-- Added by HTTrack -->


<head>
    <title>Premium Video Package for all types of businesses </title>

    <meta name="description" content="Our videos will communicate with excellent voice over, pro animations that attract your potential clients and investors. We make your dreams come true.">
...
<meta property="og:locale" content="en_GB" />
  ...
  <meta property="og:title" content="Premium Video Package for all types of businesses" />
  <meta property="og:description" content="Our videos will communicate with excellent voice over, pro animations that attract your potential clients and investors. We make your dreams come true." />
...
<?php include_once($_SERVER['DOCUMENT_ROOT'].'/includes/header.php');?>
        ...
        <div class="works-wrap">
            ...
            <section class="subscribe-fold sec-padding-60 d-none">
                ...
                <div class="container">
                    <div class="col-md-12">
                        <h1 class="myheading">Premium Video Package</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="subs-pac bronze ">
                                ...
                                <h6><span class="old">£1619.98</span> £809.99
                              ...
                              <option value="SEO">SEO</option>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="fldset">
                                                ...
                                                <input type="hidden" id="locationURL" name="page" value="https://websitevalley.co.uk/packages/premium-video-package" />
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="book-call-popupform tabform clearfix  text-left">
                        ...
                        <form id="popupfrm" class="cmxform" method="POST" action="">
                            ...
                            <div class="fldst">
                                ...
                                <input type="hidden" id="location" name="locationURL" value="http://websitevalley.co.uk/packages/premium-video-package" />
                            </div>
...
<!-- Mirrored from websitevalley.co.uk/packages/premium-video-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:25 GMT -->

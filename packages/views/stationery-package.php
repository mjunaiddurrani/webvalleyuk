...
<!-- Mirrored from websitevalley.co.uk/packages/stationery-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:19 GMT -->
<!-- Added by HTTrack -->


<head>
    <title>Custom Stationery Package for Perfect Brand Building</title>

    <meta name="description" content="Take your brand to the next level, and opt for the excellent services at a reasonable price. We create all types of custom stationery items for marketing.">
...
<meta property="og:locale" content="en_GB" />
  ...
  <meta property="og:title" content="Custom Stationery Package for Perfect Brand Building" />
  <meta property="og:description" content="Take your brand to the next level, and opt for the excellent services at a reasonable price. We create all types of custom stationery items for marketing." />
...
<?php include_once($_SERVER['DOCUMENT_ROOT'].'/includes/header.php');?>
        ...
        <div class="works-wrap">
            ...
            <section class="subscribe-fold sec-padding-60">
                ...
                <div class="container">
                    <div class="col-md-12">
                        <h1 class="myheading">Stationery Package</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="subs-pac bronze ">
                                ...
                                <h6><span class="old">£149.98</span> £74.99
                                ...
                                <div class="table-packages bronze">
                                    ...
                                    <div class="body">
                                        <ul class="subscription-list">
                                            ...
                                            <li>
                                                <h6>3 Design Revisions</h6>

                                            </li>
                                            <li>
                                                <h6>Turnaround Time 24 - 48 Hours</h6>
                              ...
                              <option value="SEO">SEO</option>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="fldset">
                                                ...
                                                <input type="hidden" id="locationURL" name="page" value="https://websitevalley.co.uk/packages/stationery-package" />
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="book-call-popupform tabform clearfix  text-left">
                        ...
                        <form id="popupfrm" class="cmxform" method="POST" action="">
                            ...
                            <div class="fldst">
                                ...
                                <input type="hidden" id="location" name="locationURL" value="http://websitevalley.co.uk/packages/stationery-package" />
                            </div>
...
<!-- Mirrored from websitevalley.co.uk/packages/stationery-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:20 GMT -->

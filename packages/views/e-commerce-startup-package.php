...
<!-- Mirrored from websitevalley.co.uk/packages/e-commerce-startup-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:13 GMT -->
<!-- Added by HTTrack -->


<head>
    <title>Our ecommerce Startup Package for Entrepreneurs</title>

    <meta name="description" content="Starting a new business online? Check out our startup packages for competitive market price packages. We provide the best branding solutions for business.">
...
<meta property="og:locale" content="en_GB" />
  ...
  <meta property="og:title" content="Our ecommerce Startup Package for Entrepreneurs" />
  <meta property="og:description" content="Starting a new business online? Check out our startup packages for competitive market price packages. We provide the best branding solutions for business." />
...
<?php include_once($_SERVER['DOCUMENT_ROOT'].'/includes/header.php');?>
        ...
        <div class="works-wrap">
            ...
            <section class="subscribe-fold sec-padding-60">
                ...
                <div class="container">
                    <div class="col-md-12">
                        <h1 class="myheading">E-Commerce Startup Package</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="subs-pac bronze ">
                                <h3>E-Commerce Startup <br/>Package</h3>
                                <h6><span class="old">£1,200.00</span> £600
                                ...
                                <div class="table-packages bronze">
                                    ...
                                    <div class="body">
                                        <ul class="subscription-list">
                                            <li>
                                                <h6>Up-to 100 Products</h6>
                                            </li>
                                            <li>
                                                <h6>Content Management System (CMS)</h6>
                                            </li>
                                            <li>
                                                <h6>Mini Shopping Cart Integration</h6>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <h6>Dedicated designer &amp; developer</h6>
                                            </li>
                                            <li>
                              ...
                              <option value="SEO">SEO</option>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="fldset">
                                                ...
                                                <input type="hidden" id="locationURL" name="page" value="https://websitevalley.co.uk/packages/e-commerce-startup-package" />
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="book-call-popupform tabform clearfix  text-left">
                        ...
                        <form id="popupfrm" class="cmxform" method="POST" action="">
                            ...
                            <div class="fldst">
                                ...
                                <input type="hidden" id="location" name="locationURL" value="http://websitevalley.co.uk/packages/e-commerce-startup-package" />
                            </div>
...
<!-- Mirrored from websitevalley.co.uk/packages/e-commerce-startup-package by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:14 GMT -->

...
<!-- Mirrored from webprohub.co.uk/portfolio by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:06 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<title>Portfolio | Web Pro Hub</title>
...
<!-- <li>
  ...
  <a href="javascript:;" class="btn-main" id="loadmorevideo" style="font-size: 14px;margin-top: 20px;">View More</a>
          ...
          <div id="ecom" class="tab-pane">
            <ul class="portfoliolist grid loadmoreecomm web-design-portfolio-slider">
               <div>
  <li class="border-box-effect logoportfo" data-category="transition">
...
<!-- <li>
  <a href="javascript:;" class="btn-main" id="loadmoreecomm" style="font-size: 14px;margin-top: 20px;">View More</a>
</li> -->
                ...
                <div class="ban-form">
                  <form class="cmxform" id="bannerform" method="POST" action="https://webprohub.co.uk/webpages/orderFormController.php">
                    <div class="row">
                      ...
                      <input type="hidden" name="ctry" value="">
                      <input type="hidden" name="pc" value="">
                      <input type="hidden" id="locationURL" name="page" value="https://webprohub.co.uk/portfolio" />
                        </div>
                      </div>
                    </div>
                  </form>
       ...
       <div class="book-call-ys-popup-content">
           ...
           <span class="heading">Book a Call </span>
             ...
             <form id="popupfrm" class="cmxform"  method="POST" action="https://webprohub.co.uk/webpages/bookacallFormController.php">
              ...
              <input type="hidden" id="location" name="locationURL" value="http://webprohub.co.uk/portfolio" />
               </div>
...
<!-- Mirrored from webprohub.co.uk/portfolio by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:41:07 GMT -->
</html>
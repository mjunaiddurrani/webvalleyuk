      ...
      <div class="row">
        <div class="col-md-6">
          <div class="left_side_head">
            ...
            <h2>Choose the plan that fulfills your needs best.</h2>
          </div>
        </div>
        <div class="col-md-6">
          <div class="right_side_head">
            <p>Our services are unrivalled by anyone in the market, and the same goes for our plans. Get the most out of
              what we have to offer!</p>
          </div>
        </div>
        <div class="col-md-12">
          <div class="nabition_bar">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="home-tab" data-toggle="tab" data-target="#home" type="button"
                  role="tab" aria-controls="home" aria-selected="true">Web Design</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="profile-tab" data-toggle="tab" data-target="#profile" type="button"
                  role="tab" aria-controls="profile" aria-selected="false">Ecommerce</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="contact-tab" data-toggle="tab" data-target="#contact" type="button"
                  role="tab" aria-controls="contact" aria-selected="false">Branding</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="contact1-tab" data-toggle="tab" data-target="#contact1" type="button"
                  role="tab" aria-controls="contact1" aria-selected="false">Video Animation</button>
              </li>
              <li class="nav-item" role="presentation">
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="contact3-tab" data-toggle="tab" data-target="#contact3" type="button"
                  role="tab" aria-controls="contact3" aria-selected="false">Combo Packages</button>
              </li>
            </ul>
          </div>
          <div class="col-md-12">
          <div class="main_contetn_of_pakages">
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                <div class="Main_packages">

                  <div class="myCard2">
                    <p class="font-32 font-w800">Startup Website <br> Package</p>
                    <p class="font-13 text-grey contentScroll contentScroll-upper">Suitable
                      for static based landing pages.</p>
                    ...
                    <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                        class="fa fa-arrow-right pl-3"></i></button>
                    <a href="startup-website-package/" class="view-detail ">VIEW
                      DETAILS</a>
                    <div class="row bot-links">
                      <div class="col-xl-6 border-right text-center">
                        <div class="text-yellow">Share your idea?</div>
                        <a class="mob" href="tel:+447418376703">+44 74 1837 6703</a>
                      </div>
                  ...
                  <div class="myCard2">
                    ...
                    <p class="font-13 text-grey contentScroll contentScroll-upper">Suitable
                      for basic startups looking to take it one step at a time.</p>
                    <div class="d-inline-flex align-items-center">
                      <span class="font-45 font-w800 border-right text-center line-height-45 pr-2 mr-2">£499</span>
                    ...
                    <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                        class="fa fa-arrow-right pl-3"></i></button>
                    <a href="professional-website-package/" class="view-detail ">VIEW DETAILS</a>
                    <div class="row bot-links">
                      <div class="col-xl-6 border-right text-center">
                        <div class="text-yellow">Share your idea?</div>
                        <a class="mob" href="tel:+447418376703">+44 74 1837 6703</a>
                  ...
                  <div class="myCard2">
                    ...
                    <p class="font-13 text-grey contentScroll contentScroll-upper">Suitable
                      for potential startups and basic revamps for small companies.</p>
                    <div class="d-inline-flex align-items-center">
                    ...
                    <div class="contentScroll">
                      ...
                      <p class="dot-before">Online Reservation/Appointment Tool (Optional)
                      </p>
                    ...
                    <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                        class="fa fa-arrow-right pl-3"></i></button>
                    <a href="elite-website-package/" class="view-detail ">VIEW
                      DETAILS</a>
                    <div class="row bot-links">
                      <div class="col-xl-6 border-right text-center">
                        <div class="text-yellow">Share your idea?</div>
                  ...
                  <div class="myCard2">
                    ...
                    <p class="font-13 text-grey contentScroll contentScroll-upper">Suitable
                      for strong startups that are looking to build a unique brand
                      identity to help them stand apart from their competitors with a
                      strong brand presence and strong brand revamps for companies.</p>
                    <div class="d-inline-flex align-items-center">
                      <span
                        class="font-45 font-w800 border-right text-center line-height-45 pr-2 mr-2">£<?= $silverWebsite?></span>
                      <span class="text-dec-line-thro text-red font-24">£<?= cutPrice($silverWebsite);?></span>
                    </div>
                    <div class="contentScroll">
                      <p class="dot-before">Custom Made, Interactive, Dynamic &amp; High
                        End Design</p>
                      ...
                      <p class="dot-before">Online Appointment/Scheduling/Online Ordering
                        Integration (Optional)</p>
                      <p class="dot-before">Online Payment Integration (Optional)</p>
                      ...
                      <p class="dot-before">Live Feeds of Social Networks integration
                        (Optional)</p>
                      <p class="dot-before">Mobile Responsive</p>
                      ...
                      <p class="dot-before">Search Engine Submission</p>
                      <p class="dot-before">Complete W3C Certified HTML</p>
                      <p class="dot-before">Industry Specified Team of Expert Designers
                        and Developers</p>
                      <p class="dot-before">Complete Deployment</p>
                      <p class="dot-before">Dedicated Project Manager</p>
                    ...
                    <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                        class="fa fa-arrow-right pl-3"></i></button>
                    <a href="silver-website-package/" class="view-detail ">VIEW
                      DETAILS</a>
                    <div class="row bot-links">
                      <div class="col-xl-6 border-right text-center">
                        <div class="text-yellow">Share your idea?</div>
                  ...
                  <div class="myCard2">
                    ...
                    <p class="font-13 text-grey contentScroll contentScroll-upper">Suitable
                      for mid sized startups who are looking to work with a strong R&D,
                      Creative and marketing team to help develop a unique brand identity,
                      strong digital presense, marketing strategies and help select
                      elements to alter consumer behaviour toawrds their business. These
                      strategies will help to compete directly with some of the top
                      competitors in your target market.</p>
                    <div class="d-inline-flex align-items-center">
                      <span
                        class="font-45 font-w800 border-right text-center line-height-45 pr-2 mr-2">£<?= $businessWebsite;?></span>
                    ...
                    <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                        class="fa fa-arrow-right pl-3"></i></button>
                    <a href="business-website-package/" class="view-detail ">VIEW
                      DETAILS</a>
                    <div class="row bot-links">
                      <div class="col-xl-6 border-right text-center">
                        <div class="text-yellow">Share your idea?</div>
                  ...
                  <div class="myCard2">
                    ...
                    <p class="font-13 text-grey contentScroll contentScroll-upper">Allows
                      live conferencing features and custom client/user dashboards for
                      clients with a strong semi-automated admin panel.</p>
                    <div class="d-inline-flex align-items-center">
                    ...
                    <div class="contentScroll">
                      ...
                      <p class="dot-before">Social Media Page Designs (Facebook, Twitter,
                        Instagram)</p>
                      <p class="dot-before">Complete W3C Certified HTML</p>
                      <p class="dot-before">Dedicated Accounts Manager</p>
                      <p class="dot-before">Complete Deployment</p>
                      ...
                      <p class="dot-before">Curation of Resources And Adding Own Resources
                      </p>
                      <p class="dot-before">Dedicated Accounts Manager</p>
                    </div>
                    <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                        class="fa fa-arrow-right pl-3"></i></button>
                    <a href="automatedinteractive-conferencing-portal-package/" class="view-detail ">VIEW
                      DETAILS</a>
                    <div class="row bot-links">
                      <div class="col-xl-6 border-right text-center">
                        <div class="text-yellow">Share your idea?</div>
                  ...
                  <div class="myCard2">
                    ...
                    <p class="font-13 text-grey contentScroll contentScroll-upper">Suitable
                      for mid sized and strong Enterprises with Custom Dashboard Features,
                      Automation/Intelligence, CRM Features, Sales Automation, Forecasting
                      and Advanced back office intelligent managmement system.
                      (Job Portals, Real Estate Portals, I.T Management Portals, Medical
                      Portals, HRM Portals, CRM Portals, Dating Portals, Management
                      Portals)</p>
                    <div class="d-inline-flex align-items-center">
                    ...
                    <div class="contentScroll">
                      ...
                      <p class="dot-before">Description of the program’s objectives and
                        scope</p>
                    ...
                    <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                        class="fa fa-arrow-right pl-3"></i></button>
                    <a href="custom-crm-portal-website/" class="view-detail ">VIEW
                      DETAILS</a>
                    <div class="row bot-links">
                      <div class="col-xl-6 border-right text-center">
                        <div class="text-yellow">Share your idea?</div>
              ...
              <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                <div class="Main_packages">
                      ...
                      <div class="myCard2">
                        ...
                        <p class="font-13 text-grey contentScroll contentScroll-upper">Suitable
                          for small startups who are looking to sell products online.</p>
                        <div class="d-inline-flex align-items-center">
                          <span
                            class="font-45 font-w800 border-right text-center line-height-45 pr-2 mr-2">£<?= $beginnersEcommerce?></span>
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="beginners-e-commerce-package/" class="view-detail ">VIEW DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                            <a class="mob" href="tel:+447418376703">+44 74 1837 6703</a>
                      ...
                      <div class="myCard2">
                        ...
                        <p class="font-13 text-grey contentScroll contentScroll-upper">Suitable
                          for strong startups looking to create a client base and develop a
                          unique brand identity to help them stand apart from their
                          competitors.</p>
                        <div class="d-inline-flex align-items-center">
                          <span
                            class="font-45 font-w800 border-right text-center line-height-45 pr-2 mr-2">£<?= $corporateEcommerce?></span>
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="corporate-e-commerce-package/" class="view-detail ">VIEW DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                            <a class="mob" href="tel:+447418376703">+44 74 1837 6703</a>
                      ...
                      <div class="myCard2">
                        ...
                        <p class="font-13 text-grey contentScroll contentScroll-upper">Suitable
                          for mid sized startups/enterprises who are looking to take it on the
                          next level and grow their businesses at a much faster pace with a
                          strong brand presence.</p>
                        <div class="d-inline-flex align-items-center">
                          <span
                            class="font-45 font-w800 border-right text-center line-height-45 pr-2 mr-2">£<?= $eliteEcommerce?></span>
                        ...
                        <div class="contentScroll">
                          ...
                          <p class="dot-before">Stationary Design (BusinessCard,Letterhead
                            &amp; Envelope)</p>
                          ...
                          <p class="dot-before">Facebook , Twitter, YouTube, Google+ &amp;
                            Pinterest Page Designs</p>
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="elite-e-commerce-package/" class="view-detail ">VIEW
                          DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                      ...
                      <div class="myCard2">
                        ...
                        <p class="font-13 text-grey contentScroll contentScroll-upper">Suitable
                          for strong/mid/large sized enterprises and startups who are looking
                          to work with a strong R&D, Creative and Marketing team to help
                          select every element towards their branding, create strong digital
                          marketing and brand presence strategies and to compete with
                          mid/large level enterprises to grow at faster pace and start off
                          directly at the start of the food chain.</p>
                        <div class="d-inline-flex align-items-center">
                          <span
                            class="font-45 font-w800 border-right text-center line-height-45 pr-2 mr-2">£<?= $automatedEcommerce ?></span>
                          <span
                            class="text-dec-line-thro text-red font-24">£<?= cutPrice($automatedEcommerce); ?></span>
                        </div>
                        <div class="contentScroll">
                          <p class="dot-before">Custom Content Management System (CMS)</p>
                          <p class="dot-before">Unique Pages and UI Design</p>
                          ...
                          <p class="dot-before">Complete Deployment</p>
                          <p class="dot-before">Money Back Guarantee</p>
                          <p class="dot-before"><strong>Automated Inventory/Shipping/Supplier
                              Module:</strong></p>
                          <p class="dot-before">Manage thousands to millions of inventory with
                            ease and check stock levels in real-time. Receive low inventory
                            notifications and generate purchase orders to replenish your
                            stock.</p>
                          ...
                          <p class="dot-before">Transfer stock between warehouses (If
                            Warehouse - API NEEDED)</p>
                          <p class="dot-before">Receive stock into a specific warehouse (If
                            Warehouse - API NEEDED)</p>
                          <p class="dot-before">Fulfill orders from a particular warehouse (If
                            Warehouse - API NEEDED)</p>
                          ...
                          <p class="dot-before"><strong>Advanced Features: (API Needed For
                              Suppliers/Warehouse)</strong></p>
                          <p class="dot-before">Speak to suppliers during trivial
                            conversations.</p>
                          <p class="dot-before">Set and send actions to suppliers regarding
                            governance and compliance materials. Place purchasing requests.
                          </p>
                          <p class="dot-before">Research and answer internal questions
                            regarding procurement functionalities or a supplier/supplier
                            set.</p>
                          <p class="dot-before">Receiving/filing/documentation of invoices and
                            payments/order requests</p>
                          <p class="dot-before">Machine Learning (ML) for Supply Chain
                            Planning (SCP)</p>
                          <p class="dot-before">Machine Learning for Warehouse Management</p>
                          <p class="dot-before">Natural Language Processing (NLP) for Data
                            Cleansing and Building Data Robustness</p>
                          <p class="dot-before"><strong>Automated Invoices &amp;
                              Estimates</strong></p>
                          <p class="dot-before">Create beautiful, professional invoices &amp;
                            estimates in just a few seconds and then instantly email them as
                            PDF's directly to your customers or prospects.</p>
                          <p class="dot-before">Automated Split invoicing</p>
                          <p class="dot-before">Automated Combine invoices</p>
                          <p class="dot-before">Invoice templates</p>
                          <p class="dot-before"><strong>Automated Barcode Scanning</strong>
                          </p>
                          <p class="dot-before">Scan inventory into your orders, generate
                            barcodes for your documents, and search for inventory or
                            documents by scanning barcodes.</p>
                          <p class="dot-before"><strong>Locations and Zones</strong></p>
                          <p class="dot-before">Have multiple warehouses, offices, or retail
                            stores? No problem. Easily track where all your inventory is by
                            organizing everything into locations and zones. Organize
                            inventory items using custom attributes such as size, color, and
                            location. View how many you have globally or at each location.
                          </p>
                          ...
                          <p class="dot-before">With integrated purchase orders, you can
                            easily replenish your inventory levels by ordering more stock
                            and even track when those new items will arrive.</p>
                          ...
                          <p class="dot-before">Generate extremely detailed reports for your
                            inventory, sales and services. Filter your reports by date-range
                            and category to see what's making you the most money.</p>
                        </div>
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="automatedinteractive-e-commerce-package/" class="view-detail ">VIEW DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                            <a class="mob" href="tel:+447418376703">+44 74 1837 6703</a>
                      ...
                      <div class="myCard2">
                        ...
                        <p class="font-13 text-grey contentScroll contentScroll-upper">Suitable
                          for strong marketplaces where clients can come, sell their products
                          and customers can come and puchase where you make commision out of
                          every sale being done through the portal with multiple revenue
                          models. Includes a strong R&D, Creative and Marketing team to help
                          select every element towards their branding, create strong digital
                          marketing and brand presence strategies.</p>
                        <div class="d-inline-flex align-items-center">
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="custom-e-commerce-marketplace-package/" class="view-detail ">VIEW DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                            <a class="mob" href="tel:+447418376703">+44 74 1837 6703</a>
                      ...
                      <div class="myCard2">
                        ...
                        <p class="font-13 text-grey contentScroll contentScroll-upper">Suitable
                          for mid/large level enterprises, who are looking to create a
                          one-in-all Intelligent/Automated Organizational Management System
                          within their portal to help regulate the activities of every
                          department through one system with an AI based Back Office
                          management system and custom user/departmental rights that can help
                          connect processes from manufacturing, inventory management to final
                          order fulfillment.</p>
                        <div class="d-inline-flex align-items-center">
                        ...
                        <div class="contentScroll">
                          ...
                          <p class="dot-before">Financial Reports</p>
                          <p class="dot-before">Generate extremely detailed reports for your
                            sales and services. Filter your reports by date-range and
                            category to see what's making you the most money.</p>
                          <p class="dot-before">Generate automated sales reports</p>
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="custom-crm-erp-portal-website/" class="view-detail ">VIEW DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                            <a class="mob" href="tel:+447418376703">+44 74 1837 6703</a>
              ...
              <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                <div class="Main_packages">
                      ...
                      <div class="myCard2">
                        ...
                        <p class="font-13 text-grey">Suitable for potential startups and brand
                          revamps for companies.</p>
                        <div class="d-inline-flex align-items-center">
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="startup-collateral-packages/" class="view-detail ">VIEW DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                            <a class="mob" href="tel:+447418376703">+44 74 1837 6703</a>
                      ...
                      <div class="myCard2">
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="collateral-classic-packages/" class="view-detail ">VIEW DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                            <a class="mob" href="tel:+447418376703">+44 74 1837 6703</a>
                      ...
                      <div class="myCard2">
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="branding-premium-collateral-packages/" class="view-detail ">VIEW DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                            <a class="mob" href="tel:+447418376703">+44 74 1837 6703</a>
                      ...
                      <div class="myCard2">
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="unlimited-collateral-packages/" class="view-detail ">VIEW DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                            <a class="mob" href="tel:+447418376703">+44 74 1837 6703</a>
                      ...
                      <div class="myCard2">
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="complete-branding-package/" class="view-detail ">VIEW
                          DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                ...
                <div class="Main_packages">
                      ...
                      <div class="myCard2">
                        ...
                        <div class="contentScroll">
                          ...
                          <p class="dot-before">Voice - Over &amp; Sound Effects (All accents)
                            (M/F)</p>
                          <p class="dot-before">Unlimited Revisions</p>
                        </div>
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="teaser-intro-video-packages/" class="view-detail ">VIEW DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                            <a class="mob" href="tel:+447418376703">+44 74 1837 6703</a>
                      ...
                      <div class="myCard2">
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="startup-video-packages/" class="view-detail ">VIEW
                          DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                      ...
                      <div class="myCard2">
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="classic-video-packages/" class="view-detail ">VIEW
                          DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                      ...
                      <div class="myCard2">
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="premium-video-packages/" class="view-detail ">VIEW
                          DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                      ...
                      <div class="myCard2">
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="deluxe-video-packages/" class="view-detail ">VIEW
                          DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                ...
                <div class="Main_packages">
                      ...
                      <div class="myCard2">
                        ...
                        <div class="contentScroll">
                          ...
                          <p class="dot-before">Informational Content Writing &amp; Sharing (2
                            - Per Month)</p>
                          <p class="dot-before">Blog Writing (1 - Per Month)</p>
                          <p class="dot-before">Press Release Social Bookmarking (5 - Per
                            Month)</p>
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="startup-seo-website-package/" class="view-detail ">VIEW DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                            <a class="mob" href="tel:+447418376703">+44 74 1837 6703</a>
                      ...
                      <div class="myCard2">
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="identity-seo-package/" class="view-detail ">VIEW
                          DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                      ...
                      <div class="myCard2">
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="elite-seo-package/" class="view-detail ">VIEW
                          DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                      ...
                      <div class="myCard2">
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="professional-seo-package/" class="view-detail ">VIEW
                          DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
              ...
              <div class="tab-pane fade" id="contact3" role="tabpanel" aria-labelledby="contact3-tab">
                <div class="Main_packages">
                      ...
                      <div class="myCard2">
                        ...
                        <div class="d-inline-flex align-items-center">
                          <span
                            class="font-45 font-w800 border-right text-center line-height-45 pr-2 mr-2">£<?= $basicCombo ?></span>
                        ...
                        <div class="contentScroll">
                          ...
                          <p class="dot-before"> Icon Design</p>
                          <p class="dot-before">Business Card, Letterhead, Envelope, Fax
                            Template</p>
                          <p class="dot-before">MS Word Letterhead</p>
                          <p class="dot-before">5 Page Website</p>
                          <p class="dot-before">Mobile Responsive</p>
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="basic-combo-package/" class="view-detail ">VIEW
                          DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                      ...
                      <div class="myCard2">
                        ...
                        <div class="d-inline-flex align-items-center">
                          <span
                            class="font-45 font-w800 border-right text-center line-height-45 pr-2 mr-2">£<?= $startupCombo ?></span>
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="startup-combo-package/" class="view-detail ">VIEW
                          DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                      ...
                      <div class="myCard2">
                        ...
                        <div class="d-inline-flex align-items-center">
                          <span
                            class="font-45 font-w800 border-right text-center line-height-45 pr-2 mr-2">£<?= $professionalCombo ?></span>
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="professional-combo-package/" class="view-detail ">VIEW
                          DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                      ...
                      <div class="myCard2">
                        ...
                        <div class="contentScroll">
                          ...
                          <p class="dot-before">Social Media Integration</p>
                          <p class="dot-before">Search Engine Submission</p>
                          <p class="dot-before">Team of Dedicated Designers, Developers and
                            Brand Experts</p>
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="corporate-combo-package/" class="view-detail ">VIEW
                          DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>
                      ...
                      <div class="myCard2">
                        ...
                        <div class="contentScroll">
                          ...
                          <p class="dot-before">Award Winning Team of Expert Designers and
                            Developers</p>
                          <p class="dot-before">Complete Deployment</p>
                          <p class="dot-before">Facebook Page Design</p>
                          <p class="dot-before">Twitter Page Design</p>
                        ...
                        <button class="btn btn-yellow m-0 px-5 formBtn_ popupBtn formBtn_ popupBtn">Start Now<i
                            class="fa fa-arrow-right pl-3"></i></button>
                        <a href="elite-combo-package/" class="view-detail ">VIEW
                          DETAILS</a>
                        <div class="row bot-links">
                          <div class="col-xl-6 border-right text-center">
                            <div class="text-yellow">Share your idea?</div>

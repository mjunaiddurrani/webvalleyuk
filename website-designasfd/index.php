...
<head>
  ...
  <link rel=apple-touch-icon href=../wp-content/uploads/2020/12/cropped-favicon_icon-5-180x180.png>
  <meta name="msapplication-TileImage" content="/wp-content/uploads/2020/12/cropped-favicon_icon-5-270x270.png">
...
<body data-rsssl=1 class="page-template-default page page-id-83">
  ...
  <header style="background: linear-gradient(#171717, #525252);background-image: url('../wp-content/uploads/2021/02/webpage_banner_upd.png');">
    <div class=container>
        ...
        <div class="collapse navbar-collapse" id=navbarSupportedContent>
          <ul id=menu-main-menu class="navbar-nav ml-auto">
            ...
            <li id=menu-item-8 class="menu-item menu-item-type-custom menu-item-object-custom menu-item-8">
              <a title=telephoneNumber href="tel:+44 4423 191348"><i class="fa fa-phone-alt"></i><span>+44 4423 191348</span></a>
            </li>
            <li id=menu-item-345 class="custom-btn-bg-nav menu-item menu-item-type-post_type menu-item-object-page menu-item-345">
              <a href="javascript:void(0)" data-toggle="modal" data-target="#modalForDiscount">Get Free Quote</a>
            </li>
          </ul>
        </div>
      </nav>
        ...
        <div class="col-md-5 offset-md-1 contentSection_right">
          <div class=banner_form>
            ...
            <div class="wpforms-container wpforms-container-full form_ConnectWithUs" id=>
              <form class="wpforms-validate wpforms-form " method='post' action="/leads/">
                <input type="hidden" name="route" value="<?= $_SERVER['REQUEST_URI'] ?>">
                <input type="hidden" name="brand" value="webvalleyuk">
                <input type="hidden" name="token" value="<?= $token; ?>">
                <input type="hidden" name="tag" value="modal-auto">
                ...
                <div class=wpforms-field-container>
                  <div id=wpforms-171-field_0-container class="wpforms-field wpforms-field-name" data-field-id=0><label class="wpforms-field-label wpforms-label-hide" for=wpforms-171-field_0>Name <span class=wpforms-required-label>*</span></label>
                    <div class="wpforms-field-row wpforms-field-large">
                      <div class="wpforms-field-row-block wpforms-first wpforms-one-half"><input type=text id=wpforms-171-field_0 class="wpforms-field-name-first wpforms-field-required" name="name" placeholder="First Name " required><label for=wpforms-171-field_0 class="wpforms-field-sublabel after wpforms-sublabel-hide">First</label>
                      </div>
                      <div class="wpforms-field-row-block wpforms-one-half"><input type=text id=wpforms-171-field_0-last class="wpforms-field-name-last wpforms-field-required" name="email" placeholder="Email" required><label for=wpforms-171-field_0-last class="wpforms-field-sublabel after wpforms-sublabel-hide">Email</label>
                      </div>
                    </div>
                  </div>
                  <div class=wpforms-field-container>
                    <div id=wpforms-171-field_1-container class="wpforms-field wpforms-field-name" data-field-id=0><label class="wpforms-field-label wpforms-label-hide" for=wpforms-171-field_0>Name <span class=wpforms-required-label>*</span></label>
                      <div class="wpforms-field-row wpforms-field-large">
                        <div class="wpforms-field-row-block wpforms-first "><input type=text id=wpforms-171-field_0 class="wpforms-field-name-first phone wpforms-field-required" name="phone" placeholder="Phone number " required><label for=wpforms-171-field_0 class="wpforms-field-sublabel after wpforms-sublabel-hide">Phone</label>
                        </div>

                      </div>
                    </div>

                    <div id=wpforms-171-field_4-container class="wpforms-field wpforms-field-textarea" data-field-id=4><label class="wpforms-field-label wpforms-label-hide" for=wpforms-171-field_4>Talk about your project <span class=wpforms-required-label>*</span></label><textarea id=wpforms-171-field_4 class="wpforms-field-large wpforms-field-required" name=wpforms[fields][4] placeholder="Talk about your project" required></textarea></div>
                  </div>
                  <div class="wpforms-field wpforms-field-hp"><label for=wpforms-171-field-hp class=wpforms-field-label>Email</label><input type=text name=wpforms[hp] id=wpforms-171-field-hp class=wpforms-field-medium></div>
                  <div class=wpforms-submit-container><input type=hidden name=wpforms[id] value=171><input type=hidden name=wpforms[author] value=1><input type=hidden name=wpforms[post_id] value=83><button type=submit name=wpforms[submit] class="wpforms-submit " id=wpforms-submit-171 value=wpforms-submit aria-live=assertive data-alt-text=Sending... data-submit-text="CONTACT OUR TEAM">CONTACT OUR TEAM</button><img src=/wp-content/plugins/wpforms/assets/images/submit-spin.svg class=wpforms-submit-spinner style="display: none;" width=26 height=26 alt>
                  </div>
              </form>
            </div>
          </div>
        ...
        <div class=row>
          <div class=col-md-4>
            <div class=feature-content-div>
              <div class="icon ani_one"><img loading=lazy class="img-fluid animate__animated animate__flip" src=../wp-content/themes/edigisol/assets/images/Features_icon_1.png alt=img width=100% height=100% data-anijs="if: scroll, on: window, do:animate__animated animate__flip, to: .icon.ani_one .img-fluid, before: scrollReveal">
              </div>
          ...
          <div class=col-md-4>
            <div class="feature-content-div feature_bg">
              <div class="icon ani_two"><img loading=lazy class="img-fluid animate__animated animate__flip" src=../wp-content/themes/edigisol/assets/images/Features_icon_2.png alt=img width=100% height=100% data-anijs="if: scroll, on: window, do:animate__animated animate__flip, to: .ani_two.icon .img-fluid, before: scrollReveal">
              </div>
      ...
      <div class=row>
        <div class="col-md-6 align-self-center">
          ...
          <div class=call_to_action>
            <a href="javascript:void(0)" data-toggle="modal" data-target="#modalForDiscount" class="btn custom-btn-bg" aria-label="lets start">LET'S
              START</a>
            <a href="javascript:void(0)" class="btn liveChat custom-btn-nobg" aria-label="WANT TO DISCUSS">WANT
              TO
              DISCUSS?</a>
          </div>
        </div>
                    ...
                    <div class="actions">
                      <div class="row">
                        <div class="col-md-6 col-xs-6">
                          <div class="act-box1">
                            <a class="spek-us" tabindex="0" href="tel:+44 4423 191348">
                              <span><small>Speak with us</small>+44 4423 191348</span>
                            </a>
                          </div>
                        </div>
                        <div class="col-md-6 col-xs-6">
  ...
  <section class=faqs>
    <div class=container>
      <div class=row>
        ...
        <div class=col-md-12><button class=accordion>What is an estimated time-frame for website
            designing?</button>
          <div class=panel>
          ...
          <div class=panel>
            <p>There is no fixed number for that as it solely depends on the website's requirements. We are
              available to discuss your Project along with our quote.</p>
          </div><button class=accordion>Will my website be optimized for mobile friendly/responsive?</button>
          <div class=panel>
            <p>We understand how important it is to have a mobile optimized website, so all our website
              designs are responsive, and ready for all screen sizes.</p>
          </div><button class=accordion>Will my website design be compliant with search-engine?</button>
          <div class=panel>
            <p>We create all website designs while ensuring search engine friendly features. This means all
              designs are compliant with the SEO principles and guidelines. Our team makes sure your
              website design is up to date and compliant with the new rules.</p>
            <p>However, re-evaluating your website after sometime is necessary since search engines
              frequently change rules along with algorithms.</p>
          </div><button class=accordion>Do you only use WordPress as a CMS?</button>
          <div class=panel>
            <p>Our company does not focus on WordPress alone but offers other CMS solutions as well.
              However, WordPress is mostly used by customers as it suits every type of business. If you
              still require another CMS solution, we will be more than willing to offer it. You may
              contact our representative to find out which CMS will best suit your business.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class=row>
        ...
        <div class="col-md-4 align-self-center">
          ...
          <div class=strip-detial>
            ...
            <h2><a href="tel:+44 4423 191348">+44 4423 191348</a></h2>
          </div>
        </div>
        <div class="col-md-5 align-self-center">
    ...
    <section class=footer-main>
      <div class=container>
        <div class=row>
              ...
              <div class=col-md-4>
                ...
                <ul id=menu-services class=footer-menu>
                  ...
                  <li id=menu-item-457 class="menu-item menu-item-type-post_type menu-item-object-page menu-item-457">
                    <a href="javascript:void(0)" data-toggle="modal" data-target="#modalForDiscount">Get a Free Quote</a>
                  </li>
                </ul>
              </div>
              <div class=col-md-4>
          ...
          <div class=col-md-4>
            <div class=footer-logo><img src=../wp-content/themes/edigisol/assets/images/logopoppin_logo.png alt=img width=100% height=100% class=img-fluid></div>
            <div class=footer-social>
              <ul class=social-media-links>
                <li><a href=https://www.facebook.com/logopoppin rel="noopener noreferrer" target=_blank aria-label="Facebook Link"><img src='../wp-content/themes/edigisol/assets/images/footer_Fb.svg' alt=img width=100% height=100% class=img-fluid></a></li>
                <li><a href=https://www.instagram.com/logo_poppin/ rel="noopener noreferrer" aria-label="Insta Link" target=_blank><img src='../wp-content/themes/edigisol/assets/images/footer_Insta.svg' alt=img width=100% height=100% class=img-fluid></a></li>
                <li><a href=https://twitter.com/LogoPoppin rel="noopener noreferrer" aria-label="Twitter Link" target=_blank><img src='../wp-content/themes/edigisol/assets/images/footer_Twitter.svg' alt=img width=100% height=100% class=img-fluid></a></li>
                <li><a href=https://www.linkedin.com/company/logopoppins/ target=_blank rel="noopener noreferrer" aria-label="Linkedin Link"><img src='../wp-content/themes/edigisol/assets/images/footer_LinkedIn.svg' alt=img width=100% height=100% class=img-fluid></a></li>
              </ul>
            </div>
          </div>
        </div>
  ...
  <script>
    window.setTimeout(function() {
      ...
      LC_API.on_chat_started = function() {
        ...
        google_conversion_id = '436775381';
        google_conversion_label = 'IjzsCKjt_PQBENXTotAB';
        img = new Image(1, 1);

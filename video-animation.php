...
<!-- Mirrored from webprohub.co.uk/video-animation by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:40:44 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<title>Video Animation Services In UK | Web Pro Hub</title>
<meta name="keywords" content="Video Animation Services in UK , Video animation , animated video , explainer video">
<meta name="description" content="Animation that keeps you real benefits">
...
<body class="innerpages vdeopge hdar-clr">
            ...
            <ul class="forpgactive">
              ...
              <li class=""><a href="ecommerce-website-design.html">Ecommerce Solutions</a></li>
               <li class=""><a href="web-app-development.html">Web App Development</a></li>
                    ...
                    <li class="active"><a href="video-animation.html">Video Animation</a></li>
...
<div class="slider-wrapper">
  <section class="banslidee">
    <div class="item">
      <div class="home-banner d-flex" style="background-image:url(assets/images/banners/video-01.png)">
          ...
          <div class="row">
            <div class=" col-lg-5">
              <div class="home-banner-content">
                ...
                <a href="order.html" class="btn-theme">Get a Design Now </a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="item">
      <div class="home-banner d-flex" style="background-image:url(assets/images/banners/video-02.png)">
        <div class="container align-self-center">
          <div class="row">
            <div class=" col-lg-5">
              <div class="home-banner-content">
...
<section class="servicesec">
  ...
  <div class="left">
    ...
    <p>Video is the most effective medium to communicate in today’s time. At Web Prohub, we believe in creating animated videos that are derived out of the essence of your brand. Web Prohub works through videos to help you create, promote and sell.</p>
    ...
    <a href="order.html" class="btn-theme">Animate in just £209.99 </a>
  </div>
  <div class="right">
    <figure>
                ...
                <div class="ban-form">
                  <form class="cmxform" id="bannerform" method="POST" action="https://webprohub.co.uk/webpages/orderFormController.php">
                    <div class="row">
                      ...
                      <input type="hidden" name="ctry" value="">
                      <input type="hidden" name="pc" value="">
                      <input type="hidden" id="locationURL" name="page" value="https://webprohub.co.uk/video-animation" />
                        </div>
                      </div>
                    </div>
                  </form>
       ...
       <div class="book-call-ys-popup-content">
           ...
           <span class="heading">Book a Call </span>
             ...
             <form id="popupfrm" class="cmxform"  method="POST" action="https://webprohub.co.uk/webpages/bookacallFormController.php">
              ...
              <input type="hidden" id="location" name="locationURL" value="http://webprohub.co.uk/video-animation" />
               </div>
...
<!-- Mirrored from webprohub.co.uk/video-animation by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:40:46 GMT -->
</html>
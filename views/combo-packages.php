...
<section class="sec-padding pricing-sec mtpx-100">
  ...
  <div class="package_inner">
    ...
    <h2><span class="currency_symbol">£</span>444.99 <span><s>£889.98</s></span> </h2>
    ...
    <div class="price-btnwrap">
      <a href="order13f9.html?pack=18" class="btn-packages">Place Your Order</a>
    </div>
  ...
  <div class="package_inner">
    ...
    <h2><span class="currency_symbol">£</span>794.00 <span><s>£1588.00</s></span> </h2>
    <!-- <p>Suitable for potential super-startups and brand revamps for companies.</p> -->
    <!-- <div class="hrline"></div> -->
    ...
    <div class="price-btnwrap">
      <a href="order8baa.html?pack=19" class="btn-packages">Place Your Order</a>
    </div>
  ...
  <div class="package_inner">
    ...
    <h2><span class="currency_symbol">£</span>1,044.99 <span><s>£2089.98</s></span> </h2>
    <!-- <p>Suitable for potential super-startups and brand revamps for companies.</p> -->
    <!-- <div class="hrline"></div> -->
    <!-- <h3>Payable Amount</h3> -->
    <ul class="ticklist2 list-scroll">
    ...
    <div class="price-btnwrap">
      <a href="order501e.html?pack=20" class="btn-packages">Place Your Order</a>
    </div>
  ...
  <div class="package_inner">
    ...
    <h2><span class="currency_symbol">£</span>1,344.99 <span><s>£2689.98</s></span> </h2>
    <!-- <p>Suitable for potential super-startups and brand revamps for companies.</p> -->
    <!-- <div class="hrline"></div> -->
    <ul class="ticklist2 list-scroll">
      <li class="heading">Logo Design</li>
    ...
    <div class="price-btnwrap">
      <a href="order817a.html?pack=21" class="btn-packages">Place Your Order</a>
    </div>
  </div>
  ...
  <div class="package_inner">
    ...
    <h2><span class="currency_symbol">£</span>1,994.99 <span><s>£3,989.98</s></span> </h2>
    <!-- <p>Suitable for potential super-startups and brand revamps for companies.</p> -->
    <!-- <div class="hrline"></div> -->
    <ul class="ticklist2 list-scroll">
      <li class="heading">Logo Design</li>
    ...
    <div class="price-btnwrap">
      <a href="order7995.html?pack=22" class="btn-packages">Place Your Order</a>
    </div>
  </div>

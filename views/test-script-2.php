...
<body class="hompg hdar-clr">
  ...
  <nav>
    <ul>
      <li>
        <a href="/test-script/">page 1 </a>
        <a href="/test-script-2/">page 2</a>
        <a href="/test-script-3/">page 3</a>
      </li>
    </ul>
  </nav>
...
<script id="ourdesk-script" src="https://widget.custom-ourbase.com/cdn.js?bg_color=red&color=white" ></script>

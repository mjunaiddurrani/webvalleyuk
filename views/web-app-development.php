      ...
      <div class="col-lg-6 ">
        <div class="txtwrap ">
          ...
          <ul class="myticks " >
            ...
            <li class="text-primary myTickLiNew text-left" onClick="location.href='/branding/'" style="cursor:pointer;">
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="contexthere">
              ...
              <p>
              Get advantage of your online presence with the help of our web-based <a href="/mobile-app-development/" style="color:#007bff;">app development company.</a> Our experts will create high-performing applications that will help you reach a wider audience and improve your income streams.</p>
            </div>
            <div class="contexthere">

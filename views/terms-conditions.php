...
<meta property="og:locale" content="en_GB" />
  ...
  <meta property="og:title" content="Our Terms and Conditions Page at the Website Valley" />
  <meta property="og:description" content="This page informs us about all the terms and conditions of working with us. You can opt out of our services if you disagree with our terms. Check out T&Cs" />
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
           ...
           <div class="container">
        <h1 class="text-black"><strong>REVISION POLICY</strong></h1>
...
<ul>
        <p> <strong>All refund requests will be fulfilled as per the following arrangement:</strong></p>
         ...
         <li>  All refund requests should be communicated to the support department. Website Valley, based on the violation of your user agreement reserves the right to approve/disapprove your request on an individual case to case basis. </li>
         <li>  For Website Valley/ Custom packages, refund will be applicable the same as it is on the single packages. 
</li>
          ...
          <li>  Claim your refund specifying your concern by contacting us via any of the following three modes:
           ...
           <li>  We will try to resolve your concern by virtue of our revision policy immediately or else will email you a refund request approval from our refund department. After the refund, your design rights would be obtained by Website Valleyand you would not be able to display any version of the design sent by company. Let us also specify that:
            <ul>
               ...
               <li>  Working in collaboration with the Government Copyright Agencies Website Valleywould share Copyright Acquisition information for the refunded designs that would restrict the re-use of the designs as original designs in the future.
               
               If you have any questions or concerns about our Refund Policy, please contact us by clicking here <a href="mailto:query@websitevalley.co.uk">query@websitevalley.co.uk</a>.
               </li>
            </ul>
           </li>
         </ul>
         <p><strong>Disclaimer</strong></p>
         <p> All company logos and trademarks appearing on our website are the property of their respective owners.

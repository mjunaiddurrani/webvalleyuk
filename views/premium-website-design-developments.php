          ...
          <div class="boxednav">
            ...
            <div class="navigation">
              ...
              <ul class="infochannel">
                <li><a class="numbercta" href="tel:+442039301277"><i class="fa fa-phone" style="color: #dd3854;margin-right: 5px;"></i>+44 2038 087061</a></li>
                  ...
                  <div class=" col-lg-6">
                    <div class="home-banner-content">
                      ...
                      <div class="btn-wrap">
                        ...
                        <a href="tel:+442039301277" class="btn-secondary-outline">+44 2038 087061</a>
                      </div>
                    </div>
                  </div>
      ...
      <div class="row">
        <div class="col-md-7">
          ...
          <div class="btnwrap">
            ...
            <a href="tel:+442039301277" class="btn-secondary-outline" tabindex="0">+44 2038 087061</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <a data-fancybox="port" href="images/web-9.jpg">
      <figure>
        <img src="images/web-9.jpg" alt="">
            ...
            <div class="btn-wrap">
              <a href="tel:+442039301277" class="btn-primary">+44 2038 087061</a>
          ...
          <div class="combopackwrap">
            ...
            <div class="footterr">
              <div class="left">
                ...
                <div class="btnwrap">
                  <a class="numbercta" href="tel:+442039301277">+44 2038 087061</a>
      ...
      <li><a href="/contact-us/">Contact</a></li>
        ...
        <div class="col-lg-3 col-md-3 col-sm-12">
          ...
          <ul class="linkinglist">
            ...
            <li><a href="tel:+442039301277">+44 2038 087061</a></li>
...
setTimeout(function(){  
    ...
    $(document).on('click','.formBtn',function(){
      if(window.innerWidth > 600){
        ...
        window.open('tel:+442039301277','_self');
      }

...
<section class="servicesec">
  ...
  <div class="right">
    <figure>
      <img src="assets/images/websiteimage.svg" alt="">
    </figure>
  </div>
            </div>
          </div>
    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ul class="portfoliolist grid">
          <div>
<li class=" webdeign border-box-effect" data-category="transition"><a data-fancybox href="assets/images/portfolio/wjpgui/1.png"><img src="assets/images/portfolio/web/thumbnail/1.jpg" / alt=""></a></li>

...
<title>Shopify Web Design & Development Company | The Website Masters</title>
			...
			<div class="col-md-6">
				<div class="banner_img">
					<ul class="banner_slider">
						<li><img src="assets/images/shopify-website-design-company-GPen.png" alt=""></li>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="single_img">
					<img src="assets/images/shopify-website-design-company-trio-image.png.webp" alt="">
				</div>
			</div>
...
<section class="video_sec">
	<video autoplay muted>
		<source src="assets/images/logos-small.m4v" type="video/mp4">
		<source src="assets/images/logos-small.m4v" type="video/ogg">		
	</video>
	<div class="container">
		<div class="row">
			<div class="col-md-12">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="shopify_tabs">
					<ul class="nav nav-tabs" id="myTab" role="tablist">
						<li class="nav-item" role="presentation">
							<button class="nav-link active" id="one-tab" data-bs-toggle="tab" data-bs-target="#one" type="button" role="tab" aria-controls="one" aria-selected="true"><img src="assets/images/tab-icon1.svg" alt="">EXPERTISE</button>
						</li>
						<li class="nav-item" role="presentation">
							<button class="nav-link" id="two-tab" data-bs-toggle="tab" data-bs-target="#two" type="button" role="tab" aria-controls="two" aria-selected="false"><img src="assets/images/tab-icon2.svg" alt="">OPTIMIZATION</button>
						</li>
						<li class="nav-item" role="presentation">
							<button class="nav-link" id="three-tab" data-bs-toggle="tab" data-bs-target="#three" type="button" role="tab" aria-controls="three" aria-selected="false"><img src="assets/images/tab-icon3.svg" alt="">BEST PRACTICES</button>
						</li>
					</ul>
					<div class="tab-content" id="myTabContent">
						<div class="tab-pane fade show active" id="one" role="tabpanel" aria-labelledby="one-tab">
							<div class="row mt-5 align-items-center">
								...
								<div class="col-md-6">
									<div class="tabs_image_wrap">
										<img src="assets/images/tab_1.jpg" alt="">
									</div>
								</div>
							</div>
						</div>
						<div class="tab-pane fade" id="two" role="tabpanel" aria-labelledby="two-tab">
							<div class="row mt-5 align-items-center">								
								<div class="col-md-6">
									<div class="tabs_image_wrap left_img">
										<img src="assets/images/tab_2.jpg" alt="">
									</div>
								</div>
								<div class="col-md-6">
									<div class="tabs_content">
						...
						<div class="tab-pane fade" id="three" role="tabpanel" aria-labelledby="three-tab">
							<div class="row mt-5 align-items-center">
								...
								<div class="col-md-6">
									<div class="tabs_image_wrap">
										<img src="assets/images/tab_3.jpg" alt="">
									</div>
								</div>
							</div>
						</div>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="shopify_tabs">
					<ul class="nav nav-tabs" id="myTab" role="tablist">
						<li class="nav-item" role="presentation">
							<button class="nav-link active" id="four-tab" data-bs-toggle="tab" data-bs-target="#four" type="button" role="tab" aria-controls="four" aria-selected="true"><img src="assets/images/tab-icon1.svg" alt="">PLAN</button>
						</li>
						<li class="nav-item" role="presentation">
							<button class="nav-link" id="five-tab" data-bs-toggle="tab" data-bs-target="#five" type="button" role="tab" aria-controls="five" aria-selected="false"><img src="assets/images/tab-icon2.svg" alt="">WIREFRAME</button>
						</li>
						<li class="nav-item" role="presentation">
							<button class="nav-link" id="six-tab" data-bs-toggle="tab" data-bs-target="#six" type="button" role="tab" aria-controls="six" aria-selected="false"><img src="assets/images/tab-icon3.svg" alt="">UI DESIGN</button>
						</li>
						<li class="nav-item" role="presentation">
							<button class="nav-link" id="seven-tab" data-bs-toggle="tab" data-bs-target="#seven" type="button" role="tab" aria-controls="seven" aria-selected="false"><img src="assets/images/tab-icon3.svg" alt="">DEVELOPMENT & LAUNCH</button>
						</li>
					</ul>
					<div class="tab-content" id="myTabContent">
						<div class="tab-pane fade show active" id="four" role="tabpanel" aria-labelledby="four-tab">
							<div class="row mt-5 align-items-center">
								<div class="col-md-6">
									<div class="tabs_content">
								...
								<div class="col-md-6">
									<div class="tabs_image_wrap">
										<img src="assets/images/tab_4.jpg" alt="">
									</div>
								</div>
							</div>
						</div>
						<div class="tab-pane fade" id="five" role="tabpanel" aria-labelledby="five-tab">
							<div class="row mt-5 align-items-center">								
								<div class="col-md-6">
									<div class="tabs_image_wrap left_img">
										<img src="assets/images/tab_5.jpg" alt="">
									</div>
								</div>
								<div class="col-md-6">
									<div class="tabs_content">
						...
						<div class="tab-pane fade" id="six" role="tabpanel" aria-labelledby="three-tab">
							<div class="row mt-5 align-items-center">
								<div class="col-md-6">
									<div class="tabs_content">
								...
								<div class="col-md-6">
									<div class="tabs_image_wrap">
										<img src="assets/images/tab_6.jpg" alt="">
									</div>
								</div>
							</div>
						</div>
						<div class="tab-pane fade" id="seven" role="tabpanel" aria-labelledby="seven-tab">
							<div class="row mt-5 align-items-center">								
								<div class="col-md-6">
									<div class="tabs_image_wrap left_img">
										<img src="assets/images/tab_7.jpg" alt="">
									</div>
								</div>
								<div class="col-md-6">
									<div class="tabs_content">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="approch_inner">
					...
					<h2>Shopify Web Design Best Practices</h2>
					<p>Our experts use eCommerce best practices so your website delivers a flawless and hassle-free shopping experience</p>
				</div>				
			</div>
		</div>
		<div class="row mt-5">
			<div class="col-md-12">
				<div class="new_sldier_new">
					<div class="main">
						<div class="action">
							<a href="#" data-slide="1">INTUITIVE NAVIGATION</a>
							<a href="#" data-slide="2">VISUAL IDENTITY</a>
							<a href="#" data-slide="3">Benefits-Driven Messaging</a>
						</div>
						<div class="slider slider-for">
							<div class="item_wrap">
								<ul>
									<li>
										<img src="assets/images/shopify-website-design-company-intuitive-navigation.jpg" alt="">
									</li>
									<li>
										<h2>Streamline Your User Journeys</h2>
										<p>Help visitors easily find the products or information they are looking for to build confidence in their purchasing decisions.</p>
										<p>Use clear navigation menus, organize content and search functionalities, and simplify your checkout processes.</p>
									</li>
								</ul>
							</div>
							<div class="item_wrap">
								<ul>
									<li>
										<img src="assets/images/shopify-website-design-company-visual-identity.jpg" alt="">
									</li>
									<li>
										<h2>Streamline Your User Journeys</h2>
										<p>Help visitors easily find the products or information they are looking for to build confidence in their purchasing decisions.</p>
							...
							<div class="item_wrap">
								<ul>
									<li>
										<img src="assets/images/Shopify-website-design-company-messaging.jpg" alt="">
									</li>
									<li>
										<h2>Streamline Your User Journeys</h2>
										<p>Help visitors easily find the products or information they are looking for to build confidence in their purchasing decisions.</p>
...
<script>
$(document).ready(function(){
    // When a link in the action div is clicked

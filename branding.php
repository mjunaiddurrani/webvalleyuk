...
<!-- Mirrored from webprohub.co.uk/branding by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:40:41 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<title>Branding | Web Pro Hub</title>
...
<body class="innerpages brndgpge hdar-clr">
...
<div class="slider-wrapper">
  <section class="banslidee">
    ...
    <div class="item">
      <div class="home-banner d-flex" style="background-image:url(assets/images/banners/branding-03.png)">
        <div class="container align-self-center">
          <div class="row">
            <div class=" col-lg-5">
              <div class="home-banner-content">
...
<section class="servicesec">
  ...
  <div class="left">
    ...
    <a href="order.html" class="btn-theme">Brand your business in just £74.99</a>
  </div>
  <div class="right">
    <figure>
                ...
                <div class="ban-form">
                  <form class="cmxform" id="bannerform" method="POST" action="https://webprohub.co.uk/webpages/orderFormController.php">
                    <div class="row">
                      ...
                      <input type="hidden" name="pc" value="">
                      <input type="hidden" id="locationURL" name="page" value="https://webprohub.co.uk/branding" />
                        </div>
                      </div>
                    </div>
                  </form>
       ...
       <div class="book-call-ys-popup-content">
           ...
           <span class="heading">Book a Call </span>
             ...
             <form id="popupfrm" class="cmxform"  method="POST" action="https://webprohub.co.uk/webpages/bookacallFormController.php">
              ...
              <input type="hidden" id="location" name="locationURL" value="http://webprohub.co.uk/branding" />
               </div>
...
<!-- Mirrored from webprohub.co.uk/branding by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:40:44 GMT -->
</html>
...
<!-- Mirrored from webprohub.co.uk/website-design-prototype by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:40:52 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<title>Design & Prototype | Web Pro Hub</title>
...
<body class="innerpages webdsgnprtypge hdar-clr">
              ...
              <li class="has-submenu"><a href="javascript:;" class="menuside">More <i class="icon-plus"></i></a>
                ...
                <div class="dropdown">
                  <ul>
                    ...
                    <li class="active"><a href="website-design-prototype.html">Design & Prototype</a></li>
          ...
          <div class="row">
            <div class=" col-lg-5">
              <div class="home-banner-content">
                <h1>Our designs reflect your brand persona</h1>
                <p class="subtitle">Our futuristic design strategy helps you achieve the most desirable and interactive visual experience.</p>
                <ul class="myticks">
                  <li>Bring the World to Your Website</li>
                  <li>Responsive and User-Centric Websites</li>
                  <li>Reach and grow your audience</li>
                </ul>
                <a href="order.html" class="btn-theme">Get Your Web Design </a>
              </div>
            </div>
          </div>
        </div>
...
<section class="mprocess pbpx-0">
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        <div class="txtwrap">
          <h2>Creating a combo of strategic thinking and creative designs to deliver pixel perfect screens</h2>
          <p>We have expert-level design sense and apply truly customized design strategy that involves an iterative refinement approach, early feedback from clients, visual page design mockups, efficient proof of concept, user-centered designs and strategic development.</p>
          <ul class="whatlist">
            <li>
              <figure>
              ...
              <div class="textpart">
                <h3>Wireframing</h3>
                <p>Our fully-functional wireframing gives you the ability to closely evaluate the end-product and innovate or improve your ideas with our expert suggestions.</p>
              </div>
            </li>
            <li>
              <figure>
              ...
              <div class="textpart">
                <h3>UI Design</h3>
                <p>Implementing fast, clean, simple yet trendy design concepts, we specialize in creating amazing graphical user experiences.</p>
              </div>
            </li>
            <li>
              <figure>
              ...
              <div class="textpart">
                <h3>UX Design</h3>
                <p>Crafting remarkable user interfaces using style guides, grid systems, typography, mood boards and much more.</p>
              </div>
            </li>
                ...
                <div class="ban-form">
                  <form class="cmxform" id="bannerform" method="POST" action="https://webprohub.co.uk/webpages/orderFormController.php">
                    <div class="row">
                      ...
                      <input type="hidden" name="ctry" value="">
                      <input type="hidden" name="pc" value="">
                      <input type="hidden" id="locationURL" name="page" value="https://webprohub.co.uk/website-design-prototype" />
                        </div>
                      </div>
                    </div>
                  </form>
       ...
       <div class="book-call-ys-popup-content">
           ...
           <span class="heading">Book a Call </span>
             ...
             <form id="popupfrm" class="cmxform"  method="POST" action="https://webprohub.co.uk/webpages/bookacallFormController.php">
              ...
              <input type="hidden" id="location" name="locationURL" value="http://webprohub.co.uk/website-design-prototype" />
               </div>
...
<!-- Mirrored from webprohub.co.uk/website-design-prototype by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jan 2021 17:40:53 GMT -->
</html>